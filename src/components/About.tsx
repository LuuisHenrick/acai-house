    ...
    <section id="about" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">Sobre a Açaí House</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-20">
          ...
          <div className="text-center p-6 bg-purple-50 rounded-lg">
            ...
            <h4 className="text-xl font-semibold mb-2">Atendimento Especial</h4>
            <p className="text-gray-600">
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h4 className="text-lg font-semibold">Qualidade Sem Compromisso</h4>
                ...
                <li className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h4 className="text-lg font-semibold">Satisfação do Cliente</h4>
                    <p className="text-purple-200">
                ...
                <li className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h4 className="text-lg font-semibold">Inovação Constante</h4>
                    <p className="text-purple-200">
